...
// //   // fileUrlLike is like '/uploads/123_name.png'
// //   if (!fileUrlLike) return;
// //   // resolve to absolute disk path
// //   const diskPath = path.join(__dirname, '..', fileUrlLike);
// //   fs.unlink(diskPath, (err) => {
// //     if (err) {
// //       // log but don't crash if file missing
// //       console.warn('File remove warning:', diskPath, err.message);
// //     }
// //   });
// // };


// // Use the SAME uploads dir everywhere
...
//   try {
//     if (!fileUrlLike) return;
//     // fileUrlLike looks like "/uploads/1692_name.png" or "https://.../uploads/1692_name.png"
//     const filename = path.basename(fileUrlLike);          // => "1692_name.png"
//     const diskPath = path.join(UPLOADS_DIR, filename);    // => "<project>/uploads/1692_name.png"
//     fs.unlink(diskPath, (err) => {
...
// // Create a new blog (expects multipart/form-data with field "image")
// exports.createBlog = async (req, res) => {
//   try {
...
//     // Build the URL-like path your frontend can load
//     // Since server.js serves /uploads statically, we can store `/uploads/filename.ext`
...
//     res.status(500).json({ success: false, message: 'Server error while creating blog' });
//   }
//   console.log('REQ.FILE?', req.file, 'BODY?', req.body);
...
// // Accepts multipart/form-data; if no new file is sent, keep old image
// exports.updateBlog = async (req, res) => {
//   try {
//     const { id } = req.params;
//     const { title, description } = req.body;
...
//     let image = blog.image; // keep old by default
//     if (req.file) {
//       // remove old file
